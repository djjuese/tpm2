	    ...
	    )
{
    ...
    BnFromHex(bnE, "F0B43E94BA45ACCAACE692ED534382EB"
	      "17E6AB5A19CE7B31F4486FDFC0D28640");
    BnFromHex(bnD, "3945208F7B2144B13F36E38AC6D39F95"
 ...
 loop:
	...
	BnFromHex(bnK, "59276E27D506861A16680F3AD9CO2DCC"
	...
	pAssert(BnHexEqual(bnR, "F5A03B0648D2C4630EEAC513E1BB81A1"
	...
	pAssert(BnHexEqual(bnT, "4DFE9D9C1F5901D4E6F58E4EC3D04567"
			   "822D2550F9B88E826D1B5B3AB9CD0FE0"));
#endif
	...
	pAssert(BnHexEqual(bnS, "B1B6AA29DF212FD8763182BC0D421CA1"
			 ...
			 )
{
    ...
    pAssert(BnHexEqual(bnT,
		       "A756E53127F3F43B851C47CFEEFD9E43"
		       "A2D133CA258EF4EA73FBF4683ACDA13A"));
#endif
    // c)   verify that t > 0
    OK = !BnEqualZero(bnT);
    if(!OK)
