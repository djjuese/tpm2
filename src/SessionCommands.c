		      ...
		      )
{
    ...
    if(in->tpmKey != TPM_RH_NULL)
	{
		...
		{	
#ifdef ROSELAND_TCM2 // qsun - TCM2 support Symmetric method according GBT 29829 C.10.6.8
			if(IS_ATTRIBUTE(tpmKey->publicArea.objectAttributes, TPMA_OBJECT, restricted))
				return TPM_RCS_ATTRIBUTES + RC_StartAuthSession_tpmKey;		
#else
